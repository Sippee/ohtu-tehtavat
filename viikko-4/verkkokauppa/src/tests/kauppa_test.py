...
class TestKauppa(unittest.TestCase):
    ...
    def test_kahden_tuotteen_toinen_loppuu_ostoksen_paaytyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_arvoilla(self):
    ...
    def test_aloita_asiointi_nollaa_edellisen_ostoksen_tiedot(self):
        ...
        self.kauppa.lisaa_koriin(1)
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("keijo", "4321")

        # varmistetaan, että metodia tilisiirto on kutsuttu
        self.pankki_mock.tilisiirto.assert_called_with("keijo", 42, "4321", "33333-44455", 15)
        # toistaiseksi ei välitetä kutsuun liittyvistä argumenteista

    def test_kauppa_pyytaa_uuden_viitenumeron_jokaiselle_maksutapahtumalle(self):

        # määritellään että metodi palauttaa ensimmäisellä kutsulla 1 ja toisella 2
        ...
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("keijo", "54321")

        # ...toinen viite
        self.pankki_mock.tilisiirto.assert_called_with("keijo", 2, "54321", "33333-44455", 5)
