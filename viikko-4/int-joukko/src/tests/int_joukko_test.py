...
class TestIntJoukko(unittest.TestCase):
    ...
    def toimii_kasvatuksen_jalkeen(self, joukko):
        ...
        self.assertTrue(joukko.sisaltyy(11))
        joukko.poista(11)
        self.assertFalse(joukko.sisaltyy(11))
    ...
    def test_vain_lisatyt_luvut_loytyvat(self):
        self.assertTrue(self.joukko.sisaltyy(10))
        self.assertFalse(self.joukko.sisaltyy(5))
        self.assertTrue(self.joukko.sisaltyy(3))

    def test_poistettu_ei_ole_enaa_joukossa(self):
        self.joukko.poista(3)
        self.assertFalse(self.joukko.sisaltyy(3))
